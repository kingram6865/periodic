...
--
-- Name: properties fk_element_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_element_properties FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fk_element_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_element_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
